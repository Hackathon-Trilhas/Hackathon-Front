    ...
    <div className="app" style={{ zIndex: 1000 }}>
      ...
      theme={{
        button: {
          ...
          customIconSrc:
            "https://s3.typebot.io/public/workspaces/cm6ff7j1v0016la03qkghe8f9/typebots/cx0019o0d4ojqk141endyvb9/bubble-icon?v=1753557233911",
        },
